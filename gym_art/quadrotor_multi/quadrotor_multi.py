...
class QuadrotorEnvMulti(gym.Env):
    def __init__(self,
                 ...
                 local_metric='dist', local_coeff=0.0, use_replay_buffer=False, vis_acc_arrows=False,
                 viz_traces=40, viz_trace_nth_step=1, obstacle_obs_mode='relative', obst_penalty_fall_off=10.0):
    ...
    def init_scene_multi(self):
        ...
        self.scene = Quadrotor3DSceneMulti(
            models=models,
            w=2560, h=1440, resizable=True, multi_obstacles=self.multi_obstacles, viewpoint=self.envs[0].viewpoint,
